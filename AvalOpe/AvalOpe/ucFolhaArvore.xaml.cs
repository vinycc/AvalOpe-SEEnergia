...
{
    /// <summary>
    /// Interaction logic for ucFolhaArvore.xaml
    /// </summary>
    public partial class ucFolhaArvore : UserControl
    {
        public bool Automatico { get; set; }

        public ucFolhaArvore()
        {
            InitializeComponent();
        ...
        private void Desvio_LostFocus(object sender, RoutedEventArgs e)
        {
            ...
            else
            {
                ...
                //if (pai.ToString().Contains("ucArvoreSubtransmissao"))
                //{
                //    ((AvalOpe.UserControlsWPF.ucArvoreSubtransmissao)pai).SetFolha(this);
                //}
                //else {
                //    ((AvalOpe.ucArvoreDeCriterios)pai).SetFolha(this);
                //}
            }
        }
