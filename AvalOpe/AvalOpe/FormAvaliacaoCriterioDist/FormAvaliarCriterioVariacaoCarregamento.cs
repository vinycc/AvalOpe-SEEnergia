...
{
    public partial class FormAvaliarCriterioVariacaoCarregamento : Form
    {
        public double avaliacao { get; set; }
        public object fo { get; set; }

        public FormAvaliarCriterioVariacaoCarregamento(double pesoRoc, object f)
        {
            InitializeComponent();
        ...
        private void btSalvar_Click(object sender, EventArgs e)
        {
            ...
            ((ucArvoreDeCriterios)this.fo).criterioVARIACAOLINHA.SetDesvio(this.avaliacao);
            ((ucArvoreDeCriterios)this.fo).criterioVARIACAOLINHA.SetColor(this.avaliacao, true);
            this.Close();
        }
        #endregion
