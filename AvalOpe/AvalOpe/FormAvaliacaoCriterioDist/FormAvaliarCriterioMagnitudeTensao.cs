...
{
    public partial class FormAvaliarCriterioMagnitudeTensao : Form
    {
        public double avaliacao { get; set; }
        public object fo { get; set; }

        public FormAvaliarCriterioMagnitudeTensao(double pesoRoc, object f)
        {
            InitializeComponent();
        ...
        private void btSalvar_Click(object sender, EventArgs e)
        {
            ...
            ((ucArvoreDeCriterios)this.fo).criterioMAGNITUDETENSAO.SetDesvio(this.avaliacao);
            ((ucArvoreDeCriterios)this.fo).criterioMAGNITUDETENSAO.SetColor(this.avaliacao, true);
            this.Close();
        }
        #endregion
