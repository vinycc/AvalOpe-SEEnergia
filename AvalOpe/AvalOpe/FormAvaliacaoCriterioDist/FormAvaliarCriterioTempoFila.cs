...
{
    public partial class FormAvaliarCriterioTempoFila : Form
    {
        public double avaliacao { get; set; }
        public object fo { get; set; }

        public FormAvaliarCriterioTempoFila(double pesoRoc, object f)
        {
            InitializeComponent();
        ...
        private void btSalvar_Click(object sender, EventArgs e)
        {
            ...
            ((ucArvoreDeCriterios)this.fo).criterioTEMPOFILA.SetDesvio(this.avaliacao);
            ((ucArvoreDeCriterios)this.fo).criterioTEMPOFILA.SetColor(this.avaliacao, true);
            this.Close();
        }
        #endregion
