...
namespace AvalOpe.FormAvaliacaoCriterioSub
{
    public partial class FormAvaliarCriterioSegurancaRede : Form
    {
        ...
        private void btSalvar_Click(object sender, EventArgs e)
        {
            ...
            ((ucArvoreSubtransmissao)this.fo).criterioSEGURANCA.SetDesvio(this.avaliacao);
            ((ucArvoreSubtransmissao)this.fo).criterioSEGURANCA.SetColor(this.avaliacao, true);
            this.Close();
        }
    }
}
